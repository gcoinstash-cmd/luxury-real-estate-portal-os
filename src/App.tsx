        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-8">
          ...
          <div className="flex items-center gap-4 shrink-0">
            ...
            <button
              ...
              className="px-3 py-1.5 bg-amber-500/10 hover:bg-amber-500/20 border border-amber-500/30 hover:border-amber-400 rounded-md text-[9px] font-mono uppercase tracking-[0.2em] text-amber-400 hover:text-amber-300 transition-all duration-300 cursor-pointer"
